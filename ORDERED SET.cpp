...
int main()
{
    ...
    {
        cout<<*(s1.find_by_order(i))<<" ";  // FIND_BY_ORDER RETURNS AT ITERATOR TO THE Ith ELEMENT OF SET. I IS THE POSITION OF THE ELEMENTS IN SET.
    }
    cout<<endl;
    cout<<s1.order_of_key(5)<<endl;
    cout<<s1.order_of_key(8)<<endl;
    cout<<s1.order_of_key(2)<<endl;
    cout<<s1.order_of_key(4)<<endl;
    //  RETURNS THE LOWER BOUND.
    // THE DIFFERENCE - IF WE USE LOWER BOUND, WE GET ITERATOR, SO WE CANNOT DETERMINE THE POSITION OF THE ELEMENT IN SET. BUT HERE, WE ARE RETURNED AN INTEGER.
    timetaken;
    return 0;
}