...
/* BASE CLASSES ARE CALLED FIRST IN THE ORDER OF THE INITIALIZATION IN DERIVED CLASSES, LIKE HERE, ALPHA WILL BE CALLED, THEN BETA.. IN CASE OF MULTILEVEL DERIVED CLASSES, THE CONSTRUCTORS ARE CALLED IN ORDER OF DERIVATION, FOR EG. A->B->C, THEN WHILE C IS A DERIVED CLASS, FIRST A WILL BE CALLED, THEN B.. ALSO IF THERE IS ANY VIRTUAL BASE CLASS IN THE BASE CLASSES, IT WILL BE CALLED FIRST */
{
    ll e,g;
public:
