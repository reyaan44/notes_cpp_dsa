...
class reyaan1   // CLASS EXPLAINING DYNAMIC MEMORY ALLOCATION, DECLARING MEMORY IN CONSTRUCTOR IN HEP SAVES
                // MEMORY
{
  ll *p;        // POINTER
  ll odd=0,even=0;
public:
  ...
  ~reyaan1()        // DESTRUCTOR IS CALLED BY COMPILER IMPLICITLY DELETING OBJECTS IF THEY GO OUT OF 
                    // SCOPE, BUT HERE IF NEW IS USED, WE NEED TO CALL CONSTRUCTOR EXPLICITLY TO DELETE
